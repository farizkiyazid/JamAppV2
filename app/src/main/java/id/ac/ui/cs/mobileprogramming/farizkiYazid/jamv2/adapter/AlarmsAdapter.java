package id.ac.ui.cs.mobileprogramming.farizkiYazid.jamv2.adapter;
...
import id.ac.ui.cs.mobileprogramming.farizkiYazid.jamv2.ui.alarm.AddEditAlarmActivity;
...
public final class AlarmsAdapter extends RecyclerView.Adapter<AlarmsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(mDays == null){
            mDays = c.getResources().getStringArray(R.array.days);
        }
